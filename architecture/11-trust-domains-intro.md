...
- TEA-native DNS publication of the discovery signing certificate (TAPS deployments)  
...
### TEA-native DNS behavior

For TEA-native (TAPS) deployments:
